# Changelog-driven update rehearsal — v1.6.0

Date: 2026-09-13
Old ref: d1ea39f (workspace v1.5.3)
Changelog: versions/v1.6.0/CHANGELOG.md (4 change blocks, 0 8a-covered)
8a: PASS (scripts replaced from assets, templates/.gitignore verified)
8b: N/A (no AGENTS.md text ops)
