...
| --- | --- | --- |
| v0.4.4 | 2026-08-05 | upgrade-chain fixes: AGENTS.md data bullet sync (6c439e3 补记); historical changelog anchors v0.2.1/v0.2.7/v0.4.0 (GAP #1-3); t13 full-chain replay regression test |
